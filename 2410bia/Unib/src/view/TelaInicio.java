...
public class TelaInicio extends javax.swing.JFrame {
    ...
    private void deleteAluno(){
        dao.AlunoDAO.getInstance().delete((int) 
            tb_aluno.getModel().getValueAt(tb_aluno.getSelectedRow(), 0));
    }
    ...
    private void acionaBotao(String btn){
        switch (btn){
            ...
            case "tabela":
                ...
                if (CLICOU_ALUNO){
                    trocaPanel(pn_aluno);
                    tf_matricula_aluno.setText(tb_aluno.getValueAt(tb_aluno.getSelectedRow(), 0).toString());
                    tf_nome_aluno.setText(tb_aluno.getValueAt(tb_aluno.getSelectedRow(), 1).toString());                    
                    tf_codCurso_aluno.setText(tb_aluno.getValueAt(tb_aluno.getSelectedRow(), 3).toString());
                    //tf_dia_aluno.setSelectedItem();
                }
//                else if (CLICOU_PROF){
//                    trocaPanel(pn_prof);
//                    tf_id_prof.setText(tb_aluno.getValueAt(tb_aluno.getSelectedRow(), 0).toString());
//                    tf_nome_prof.setText(tb_aluno.getValueAt(tb_aluno.getSelectedRow(), 1).toString());
//                    tf_dia_prof.setSelectedItem(tb_prof.getValueAt(tb_aluno.getSelectedRow(), 2).toString());
...
//                else if (CLICOU_CURSO)deleteCurso();
    ...
    private void initComponents() {
        ...
        tb_aluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MATRICULA", "NOME", "DATA NASC", "CURSO"
            }
        ) {
        ...
        if (tb_aluno.getColumnModel().getColumnCount() > 0) {
            ...
            tb_aluno.getColumnModel().getColumn(3).setPreferredWidth(100);
        }
