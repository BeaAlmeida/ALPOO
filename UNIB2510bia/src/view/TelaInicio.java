...
public class TelaInicio extends javax.swing.JFrame {
    ...
    private void preencheCampos(){
        if (CLICOU_ALUNO){
            ...
            tf_codCurso_aluno.setText(tb_busca_aluno.getValueAt(tb_busca_aluno.getSelectedRow(), 3).toString());
...
//                else if (CLICOU_CURSO)deleteCurso();
    ...
    private void addListaTf(){
        ...
        listaTf.add(tf_instituto_curso);        
...
//                    p.getEndereco().getTel(),
//                    p.getEndereco().getEmail(),
    ...
    private void buscaJTable(){
        DefaultTableModel modelo = (DefaultTableModel) tb_busca_aluno.getModel();
        alinhaTabela();
        modelo.setNumRows(0);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pn_tb_aluno, javax.swing.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(pn_tb_prof, javax.swing.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE))
        );
