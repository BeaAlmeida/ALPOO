...
public class TelaInicio extends javax.swing.JFrame {
    ...
    private void cadastraAluno(){
        ...
        try{
            Aluno aluno = new Aluno(matricula, nome, dataNasc, codCurso, nomeCurso);
    ...
    private void findByCodigo() {
        ...
        aluno = dao.AlunoDAO.getInstance().findByCodigo((int) tb_aluno.getModel().getValueAt(tb_aluno.getSelectedRow() ,0));
        String data = aluno.getDataNasc();
        ...
        tf_nome_aluno.setText(aluno.getNome());
        tf_matricula_aluno.setText(String.valueOf(aluno.getMatricula()));
        tf_codCurso_aluno.setText(String.valueOf(aluno.getCodCurso()));
        tf_nomeCurso_aluno.setText(aluno.getNomeCurso());
        tf_codigo_aluno.setText(String.valueOf(aluno.getCodigo()));
    }
