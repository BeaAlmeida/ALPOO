...
CREATE TABLE `curso_has_disciplina` (
  ...
  PRIMARY KEY (`CD_CURSO`,`CD_DISCI`),
  KEY `fk_CURSO_has_DISCIPLINA_DISCIPLINA1_idx` (`CD_DISCI`),
  KEY `fk_CURSO_has_DISCIPLINA_CURSO1_idx` (`CD_CURSO`),
  CONSTRAINT `fk_CURSO_has_DISCIPLINA_CURSO1` FOREIGN KEY (`CD_CURSO`) REFERENCES `curso` (`CD_CURSO`),
  CONSTRAINT `fk_CURSO_has_DISCIPLINA_DISCIPLINA1` FOREIGN KEY (`CD_DISCI`) REFERENCES `disciplina` (`CD_DISCI`)
...
-- Dump completed on 2020-11-05 11:28:18
